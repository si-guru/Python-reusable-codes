...
logPath = os.path.split(os.path.abspath(__file__))[0] + "\\" + CONFIGURATION_FILE_NAME
if not os.path.exists(logPath):
    logPath = os.getcwd() + "\\" + CONFIGURATION_FILE_NAME
