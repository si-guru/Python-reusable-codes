...
class InterProcessCommunicator():
    """InterProcessCommunicator - A customised class which holds basic details for inter-process communication
    """
    def __init__(self, data = None, status = None,message = None, level = None, module = None, success = None):
        self.data     = data
    ...
    def __str__(self):
        message = ""
        message = message + str("InterProcessCommunicator - Used for communcation between process\n")
...
def __initiate_logger(log_object):
    ...
    Arguments:
        log_object {InterProcessCommunicator} -- log_object is an IPC object which holds basic details for inter process communication
...
def write_debug_log(log_object = None, can_log = True):
    ...
    Keyword Arguments:
        log_object {InterProcessCommunicator} -- IPC Object which holds basic communication data (default: {None})
        can_log {bool} -- Manually set whether to log the message (default: {True})
    
    Returns:
        [InterProcessCommunicator] -- IPC Object which holds basic communication data
    """
...
def write_default_log(log_object = None, can_log = True):
    """write_default_log - Writes a message into log file, based on provided log level
...
def __write_log_exception():
    ...
    log_object.message = 'Unable to load Logger/ Logger not available in '	+	called_function
